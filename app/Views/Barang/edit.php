    ...
    <div class="container mt-4">
        ...
        <form action="/barang/update/<?= $barang['id_barang'] ?>" method="post">
            ...
            <div class="mb-3">
                ...
                <select id="id_lokasi" name="id_lokasi" class="form-select" required>
                    ...
                    <?php foreach ($lokasi as $l): ?>
                        <option value="<?= $l['id_lokasi'] ?>" <?= $barang['id_lokasi'] == $l['id_lokasi'] ? 'selected' : '' ?>><?= $l['nama_lokasi'] ?></option>
                    <?php endforeach; ?>
                </select>
            </div>
            ...
            <div class="mb-3">
                ...
                <textarea id="deskripsi" name="deskripsi" class="form-control" required><?= old('deskripsi', $barang['deskripsi']) ?></textarea>
            </div>
